defmodule GroveOfWispsWeb.UsersAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_grove_of_wisps_web_users_remember_me"
  ...
  def log_out_users(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      GroveOfWispsWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_users:
      ...
      defmodule GroveOfWispsWeb.PageLive do
        use GroveOfWispsWeb, :live_view

        on_mount {GroveOfWispsWeb.UsersAuth, :mount_current_users}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{GroveOfWispsWeb.UsersAuth, :ensure_authenticated}] do
