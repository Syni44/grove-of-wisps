defmodule GroveOfWispsWeb.UsersRegistrationLive do
  use GroveOfWispsWeb, :live_view

  alias GroveOfWisps.Accounts
  alias GroveOfWisps.Accounts.Users
  ...
  def render(assigns) do
    ...
    <div class="mx-auto max-w-sm">
      <.header class="text-center">
        ...
        <:subtitle>
          Already registered?
          <.link navigate={~p"/user/log_in"} class="font-semibold text-indigo-500 hover:underline">
            Sign in
          </.link>
          to your account now.
        </:subtitle>
